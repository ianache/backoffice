...
// Lightweight lookup catalogs for WorkspaceContextSelector comboboxes (RF-01).
// mui-labeling creates its own HTTP services rather than sharing stores
// with other remotes (per 14-CONTEXT.md / mui-feature-flags precedent).
