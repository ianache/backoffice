<template>
  <div
    class="rule-simulator flex flex-col h-full bg-surface-container-lowest rounded-xl border border-outline-variant overflow-hidden"
  >
    <!-- Header -->
    <div class="px-4 py-3 border-b border-outline-variant flex items-center gap-2">
      ...
      <div
        ...
        class="ml-auto px-2 py-0.5 rounded-full text-xs font-bold bg-surface-container text-on-surface-variant"
      >
        No match
      </div>
    </div>
